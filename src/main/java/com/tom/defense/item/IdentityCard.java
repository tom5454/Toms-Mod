...
public class IdentityCard extends Item implements IIdentityCard, IPowerLinkCard, ISecurityStationLinkCard {
	...
	public void addInformation(ItemStack stack, EntityPlayer playerIn,
		...
		if(master != null)tooltip.add(I18n.format("tomsMod.tooltip.position", master.getX(),master.getY(),master.getZ()));
		if(station != null)tooltip.add(I18n.format("tomsMod.tooltip.position", station.getX(),station.getY(),station.getZ()));
	...
	public static int setValue(AccessType type, int valueTo, boolean value) {
		...
		if(value)valueTo |= 1 << type.ordinal();
		return valueTo;
	}
