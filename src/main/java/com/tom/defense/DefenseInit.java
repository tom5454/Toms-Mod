...
public class DefenseInit {
	...
	public static Item forceDuctEmpty, rangeUpgrade, rangeWidthUpgrade, rangeHeightUpgrade, projectorLens, projectorFieldType, fieldUpgrade, efficiencyUpgrade, crushedMonazit;
