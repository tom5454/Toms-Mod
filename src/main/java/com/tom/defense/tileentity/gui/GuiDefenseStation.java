...
public class GuiDefenseStation extends GuiTomsMod implements INBTPacketReceiver {
	...
	public GuiDefenseStation(InventoryPlayer inv,
			TileEntityDefenseStation te) {
	...
	public void initGui() {
		...
		fieldName = new GuiTextField(0, fontRendererObj, guiLeft+6, guiTop+6, 126, 15);
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		fontRendererObj.drawString(I18n.format("tomsmod.gui.actionRange"), 138, 30, 4210752);
		fontRendererObj.drawString(I18n.format("tomsmod.gui.informRange"), 138, 60, 4210752);
	}
	@Override
	...
	public class GuiButtonDefenseStationSelection extends GuiButton{
		...
		public void drawButton(Minecraft mc, int mouseX, int mouseY) {
			if (this.visible)
			{
				...
				this.drawTexturedModalRect(this.xPosition, this.yPosition, 65 + config.ordinal() * 16, 216, this.width, this.height);
