...
public class GuiForceFieldProjector extends GuiTomsMod {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		fontRendererObj.drawString(I18n.format("container.inventory"), 8, ySize - 96+5, 4210752);
		...
		fontRendererObj.drawString(te.getMaxEnergyStored()/1000 + "kF/" + energyV, 27, ySize - 116, 4210752);
		String drainV = ""+te.getField(1)/100D+" F/t";
		String drain = I18n.format("tomsmod.gui.powerDrain")+": ";
		fontRendererObj.drawString(drain, 8, ySize - 156, 4210752);
		fontRendererObj.drawString(drainV, 145-fontRendererObj.getStringWidth(drainV), ySize - 156, 4210752);
	}
	@Override
