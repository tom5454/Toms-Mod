...
public class MessageCamera extends MessageBase<MessageCamera> {
	...
	public void handleClientSide(MessageCamera message, EntityPlayer player) {
		TileEntityCamera camTe = (TileEntityCamera) player.world.getTileEntity(new BlockPos(message.camX, message.camY, message.camZ));
	...
	public void handleServerSide(MessageCamera message, EntityPlayer player) {
		TileEntity tileentity = player.world.getTileEntity(new BlockPos(message.camX, message.camY, message.camZ));
