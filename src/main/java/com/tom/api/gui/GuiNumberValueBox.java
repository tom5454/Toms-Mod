...
public class GuiNumberValueBox {
	...
	public class GuiButtonNextNum extends GuiButton{
		...
		public void drawButton(Minecraft mc, int mouseX, int mouseY) {
			if (this.visible)
			{
				...
				this.drawTexturedModalRect(this.xPosition, this.yPosition, 175 + i * 9, isDown ? 16 : 25, this.width, this.height);
	...
	public void draw(int mouseX, int mouseY, boolean drawButtons){
		...
		this.drawText(mc.fontRendererObj, color);
	}
