...
public enum ResearchComplexity{
	BASIC("tomsMod.research.basic", 0, 0), BRONZE("tomsMod.reserach.bronze", 0, 1), ELECTRICAL("tomsMod.research.electrical", 0, 2),
	ADVANCED("tomsMod.research.adv", 0, 3), LABORATORY("tomsMod.research.lab", 1, 0)
	;
