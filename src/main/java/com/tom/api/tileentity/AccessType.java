...
public enum AccessType {
	BLOCK_MODIFICATION("Block Modification"), CONFIGURATION("Configuration"), FIELD_TRANSPORT("Field Transport"), STAY_IN_AREA("Stay in Area"), HAVE_INVENTORY("Have Inventory"), SWITCH_DEVICES("Use Switch"), RIGHTS_MODIFICATION("Modify Rights");
