...
public class TileEntityLimitableChestRenderer extends
TileEntitySpecialRendererTomsMod<TileEntityLimitableChest> {//TileEntityChestRenderer TileEntityItemStackRenderer
	...
	@Override
	public void renderTileEntityAt(TileEntityLimitableChest te, double x,
			double y, double z, float partialTicks, int destroyStage, IBlockState state) {

		GlStateManager.enableDepth();
		GlStateManager.depthFunc(515);
		GlStateManager.depthMask(true);
		int i;
		if(te == null)te = TileEntityLimitableChestRenderer.te;
		if (!te.hasWorldObj())
		{
			i = 0;
		}
