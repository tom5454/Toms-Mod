...
public class BlockExportBus extends BlockChannelModule {

	public BlockExportBus() {
		super(0.20, 0.25);
	}

	@Override
	public PartChannelModule createNewTileEntity(World worldIn, int meta) {
		return new PartExportBus();
	}
	...
	public void breakBlockI(World worldIn, BlockPos pos, IBlockState state, MultipartTomsMod tile) {
		if (tile instanceof PartExportBus)
			spawnAsEntity(worldIn, pos, ((PartExportBus) tile).stuckStack);
	}
}
