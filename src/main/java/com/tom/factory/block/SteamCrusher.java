...
public class SteamCrusher extends BlockContainerTomsMod {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(!worldIn.isRemote)playerIn.openGui(CoreInit.modInstance, GuiIDs.steamCrusher.ordinal(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
}
