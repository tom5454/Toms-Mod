...
public class SteamAlloySmelter extends BlockContainerTomsMod {
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntitySteamAlloySmelter();
	}
	@Override
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(!worldIn.isRemote)playerIn.openGui(CoreInit.modInstance, GuiIDs.steamAlloySmelter.ordinal(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
}