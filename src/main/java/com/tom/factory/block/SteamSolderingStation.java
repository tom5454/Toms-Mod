...
public class SteamSolderingStation extends BlockContainerTomsMod {
	...
	public SteamSolderingStation() {
		super(Material.IRON);
	}

	@Override
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntitySteamSolderingStation();
	}
	@Override
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(!worldIn.isRemote)playerIn.openGui(CoreInit.modInstance, GuiIDs.steamSolderingStation.ordinal(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
}
