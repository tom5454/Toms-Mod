...
public class BasicBoiler extends BlockContainerTomsMod {
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileEntityBasicBoiler();
	}
	@Override
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos,
		...
		if(!FluidUtil.interactWithFluidHandler(heldItem, ((TileEntityBasicBoiler)worldIn.getTileEntity(pos)).getTankOnSide(side), playerIn)){
			playerIn.openGui(CoreInit.modInstance, GuiIDs.basicBoiler.ordinal(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
	@Override
