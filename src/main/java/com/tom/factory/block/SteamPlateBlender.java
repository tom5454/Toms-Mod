...
public class SteamPlateBlender extends BlockContainerTomsMod {
	public static final PropertyDirection FACING = PropertyDirection.create("facing", EnumFacing.Plane.HORIZONTAL);
	public static final PropertyBool ACTIVE = PropertyBool.create("active");
	public SteamPlateBlender() {
		super(Material.IRON);
	}
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if(!worldIn.isRemote)playerIn.openGui(CoreInit.modInstance, GuiIDs.steamPlateBlender.ordinal(), worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
}