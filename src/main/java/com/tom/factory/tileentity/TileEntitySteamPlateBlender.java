...
public class TileEntitySteamPlateBlender extends TileEntitySteamMachine {
	...
	public void checkItems() {
		ItemStackChecker s = MachineCraftingHandler.getPlateBlenderOutput(inv.getStackInSlot(0), 2);
