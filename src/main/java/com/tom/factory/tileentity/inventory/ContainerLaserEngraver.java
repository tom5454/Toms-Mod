...
public class ContainerLaserEngraver extends ContainerTomsMod {
	...
	public static class SlotBlueprint extends Slot{
		...
		public boolean isItemValid(ItemStack stack) {
			return CraftingMaterial.BLUEPRINT_BASIC_CHIPSET.equals(stack) || CraftingMaterial.BLUEPRINT_ADVANCED_CHIPSET.equals(stack) || CraftingMaterial.BLUEPRINT_FLUIX_CHIPSET.equals(stack) || CraftingMaterial.BLUEPRINT_QUANTUM_CHIPSET.equals(stack);
		}
	}
}
