...
public class GuiRefinery extends GuiTomsMod {
	...
	public void initGui() {
		...
		TomsModUtils.addRunnableToLabelList(new GuiFluidTank(this, null, guiLeft + 100, guiTop + 20, te.getTankOut1()).setUV(176, 0), labelList);
		TomsModUtils.addRunnableToLabelList(new GuiFluidTank(this, null, guiLeft + 120, guiTop + 20, te.getTankOut2()).setUV(176, 0), labelList);
		TomsModUtils.addRunnableToLabelList(new GuiFluidTank(this, null, guiLeft + 140, guiTop + 20, te.getTankOut3()).setUV(176, 0), labelList);
	}
}
