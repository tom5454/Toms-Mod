...
public class GuiPlateBendingMachine extends GuiTomsMod {
	private TileEntityPlateBendingMachine te;

	public GuiPlateBendingMachine(InventoryPlayer playerInv, TileEntityPlateBendingMachine te) {
		super(new ContainerPlateBendingMachine(playerInv, te), "plateBendingMachineGui");
		this.te = te;
	}
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		String s = I18n.format("tile.tm.plateBendingMachine.name");
