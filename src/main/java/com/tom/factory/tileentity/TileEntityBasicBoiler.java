...
public class TileEntityBasicBoiler extends TileEntityTomsMod implements ITileFluidHandler, IInventory {
	...
	public IFluidHandler getTankOnSide(EnumFacing f) {
		return ITileFluidHandler.Helper.getFluidHandlerFromTanks(new FluidTank[]{tankWater, tankSteam}, new Fluid[]{FluidRegistry.WATER, CoreInit.steam}, new boolean[]{true, false}, new boolean[]{false, true});
	}
	@Override
