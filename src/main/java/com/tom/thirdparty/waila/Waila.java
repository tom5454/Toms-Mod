...
public class Waila {
	...
	public static void onWailaCall(IWailaRegistrar registrar){
		...
		registrar.registerBodyProvider(new WailaMBFluidPort(), MultiblockFluidHatch.class);
		registrar.registerNBTProvider(new WailaMBFluidPort(), MultiblockFluidHatch.class);
