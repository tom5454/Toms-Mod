...
public class WailaHidden implements IWailaDataProvider{
	...
	public ItemStack getWailaStack(IWailaDataAccessor accessor, IWailaConfigHandler config) {
		return accessor != null && accessor.getNBTData() != null ? ItemStack.loadItemStackFromNBT(accessor.getNBTData().getCompoundTag("stack")) : null;
	}
	...
	public NBTTagCompound getNBTData(EntityPlayerMP player, TileEntity tile, NBTTagCompound tag, World world,
		...
		if(tile instanceof TileEntityHidden){
			...
			if(te.pick != null)te.pick.writeToNBT(stackTag);
