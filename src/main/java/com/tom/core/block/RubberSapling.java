...
public class RubberSapling extends BlockBush implements IGrowable {
	...
	public void generateTree(World worldIn, BlockPos pos, IBlockState state, Random rand) {
		...
		// Blocks.LOG.getDefaultState().withProperty(BlockOldLog.VARIANT,
		// BlockPlanks.EnumType.JUNGLE);
		// IBlockState iblockstate1 =
		// Blocks.LEAVES.getDefaultState().withProperty(BlockOldLeaf.VARIANT,
		// BlockPlanks.EnumType.JUNGLE).withProperty(BlockLeaves.CHECK_DECAY,
		...
		// j = 0;
		// i = 0;
		// worldgenerator = new WorldGenTrees(true, 4 + rand.nextInt(7),
		// iblockstate, iblockstate1, false);
		// }
		//
		// break;
		// case ACACIA:
