...
public class Camera extends BlockContainerTomsMod {
	...
	public void onBlockPlacedBy(World world, BlockPos pos, IBlockState bs, EntityLivingBase entity, ItemStack itemstack) {
		if (!world.isRemote) {
			...
			// ForgeDirection l = TomsMathHelper.getDirectionFacing(entity,
			// true);
	...
	public AxisAlignedBB getCollisionBoundingBox(IBlockState blockState, IBlockAccess worldIn, BlockPos pos) {
		try {
			...
			if (mc != null && mc.getRenderViewEntity() instanceof EntityCamera) { return new AxisAlignedBB(0, 0, 0, 0, 0, 0); }
		} catch (Exception e) {
