...
public class BlockRubberWood extends Block {
	...
	public static enum WoodType implements IStringSerializable{
		NORMAL("normal", 0, null), HOLE_NORTH("hole_north", 2, EnumFacing.NORTH), HOLE_CUT_NORTH("cut_hole_north", 0, EnumFacing.NORTH),
		HOLE_SOUTH("hole_south", 4, EnumFacing.SOUTH), HOLE_CUT_SOUTH("cut_hole_south", 0, EnumFacing.SOUTH),
		HOLE_EAST("hole_east", 6, EnumFacing.EAST), HOLE_CUT_EAST("cut_hole_east", 0, EnumFacing.EAST),
		HOLE_WEST("hole_west", 8, EnumFacing.WEST), HOLE_CUT_WEST("cut_hole_west", 0, EnumFacing.WEST),
		;
