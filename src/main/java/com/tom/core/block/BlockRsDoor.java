...
public class BlockRsDoor extends BlockContainerTomsMod {
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
		...
		te.activate(player, true, player.getHeldItem(hand), hand);
		return true;
	}
	...
	// IBlockState of the block being rendered.
	// If IBlockState is an instance of IExtendedBlockState, you can use it to
	// pass in any information you want.
	// Some folks return a new instance of the same ISmartBlockModel; I think it
	// is more logical to return a different
	// class which implements IBakedModel instead of ISmartBlockModel, but it's
	// a matter of taste.
	// BEWARE! Rendering is multithreaded so your ISmartBlockModel must be
