...
public class MaterialOverride {
	...
	/*public static void override(){
		if(Config.enableHardMode){
			...
			Material.wood.setRequiresTool();
			Material.ground.setRequiresTool();
			Material.packedIce.setRequiresTool();
			Material.clay.setRequiresTool();
			Material.cloth.setRequiresTool();
			Material.piston.setRequiresTool();
			Material.redstoneLight.setRequiresTool();
			Material.grass.setRequiresTool();
		}
	}
