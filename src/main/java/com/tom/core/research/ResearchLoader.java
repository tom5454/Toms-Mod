...
public class ResearchLoader {
	...
	hvCable, hvMachines, eliteTank, ultimateTank, limitableChest, advancedExtruder, mvTurbine, charger, configurator, geoThermalBoiler, geoThermalGenerator, liquidFueledBoiler, liquidFueledSteelBoiler, liquidFueledGenerator, uvLightbox, steamMixer, mixer, laserEngraver, basicChipset, advChipset;
	...
	public static void init(){
		...
		speedUpgrade = new Research("speedUpgrade", new ItemStack(FactoryInit.speedUpgrade)).setComplexity(ResearchComplexity.ELECTRICAL).addParent(basicLvMachines).setResearchTime(2000).addRequiredItem(new ItemStack(Blocks.REDSTONE_BLOCK, 16)).addRequiredItem(new ItemStack(Blocks.REDSTONE_ORE)).addRequiredItem(TMResource.BLUE_METAL.getStackNormal(Type.INGOT, 3)).addRequiredItem(CraftingMaterial.UPGRADE_FRAME.getStackNormal(2)).setComplexity(ResearchComplexity.ADVANCED);
		...
		pump = new Research("pump", new ItemStack(FactoryInit.pump)).setResearchTime(1000).addParent(basicLvMachines).setComplexity(ResearchComplexity.BRONZE).addRequiredItem(new ItemStack(CoreInit.itemPump, 2)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal()).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic));
		...
		plasticProcessing = new Research("plasticProcessing", CraftingMaterial.PLASTIC_SHEET.getStackNormal()).setComplexity(ResearchComplexity.ELECTRICAL).setResearchTime(2200).addParent(mvMachines).addParent(refinery).addRequiredItem(CraftingMaterial.BOTTLE_OF_RUBBER.getStackNormal(3)).addRequiredItem(new ItemStack(Items.SUGAR)).addRequiredItem(TMResource.COAL.getStackNormal(Type.GEM, 20));
		...
		advancedMultiblockParts = new Research("advMultiblockParts", new ItemStack(FactoryInit.AdvancedMultiblockCasing)).setComplexity(ResearchComplexity.ELECTRICAL).setResearchTime(2200).addRequiredItem(new ItemStack(FactoryInit.MultiblockCase, 4)).addRequiredItem(TMResource.TUNGSTENSTEEL.getStackNormal(Type.PLATE, 5)).addRequiredItem(new ItemStack(CoreInit.MachineFrameTitanium, 2));
		...
		configurator = new Research("configurator", new ItemStack(CoreInit.configurator)).setComplexity(ResearchComplexity.BRONZE).setResearchTime(1600).addParent(charger).addParent(lvAlloySmelter).addParent(eSolderingStation).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal(2)).addRequiredItem(new ItemStack(CoreInit.Display)).addRequiredItem(TMResource.IRON.getStackNormal(Type.PLATE, 2)).addRequiredItem(new ItemStack(Items.REDSTONE, 6));
		...
		uvLightbox = new Research("uvLightbox", new ItemStack(FactoryInit.uvLightbox)).setResearchTime(1800).addParent(basicLvMachines).setComplexity(ResearchComplexity.ELECTRICAL).addRequiredScan(Blocks.GLOWSTONE, -1).addRequiredItem(new ItemStack(Blocks.GLOWSTONE, 2)).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal()).addRequiredItem(new ItemStack(Items.REDSTONE, 6));
