...
public class ResearchLoader {
	...
	public static void init() {
		...
		basicLvMachines = new Research("basicLvMachines", new ItemStack(FactoryInit.crusher)).setComplexity(ResearchComplexity.BRONZE).addParent(lvCable).setResearchTime(900).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic)).addRequiredItem(new ItemStack(Items.FLINT, 3)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal(3)).addRequiredItem(new ItemStack(Items.REDSTONE, 6));
		...
		industrialBlastFurnace = new Research("industrialBlastFurnace", new ItemStack(FactoryInit.industrialBlastFurnace)).setComplexity(ResearchComplexity.BRONZE).setResearchTime(1200).addParent(eSolderingStation).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic)).addRequiredItem(CraftingMaterial.CUPRONICKEL_HEATING_COIL.getStackNormal(4)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal(2)).addRequiredItem(new ItemStack(CoreInit.MachineFrameSteel));
		pump = new Research("pump", new ItemStack(FactoryInit.pump)).setResearchTime(1000).addParent(basicLvMachines).setComplexity(ResearchComplexity.BRONZE).addRequiredItem(CraftingMaterial.PUMP.getStackNormal(2)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal()).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic));
		fluidTransposer = new Research("fluidTransposer", new ItemStack(FactoryInit.fluidTransposer)).setComplexity(ResearchComplexity.BRONZE).addParent(basicLvMachines).addRequiredItem(CraftingMaterial.PUMP.getStackNormal(2)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal()).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic)).addRequiredItem(new ItemStack(StorageInit.tankBasic)).setResearchTime(1100);
		...
		advancedCircuit = new Research("advCircuit", CraftingMaterial.ADVANCED_CIRCUIT.getStackNormal()).setComplexity(ResearchComplexity.ELECTRICAL).setResearchTime(2500).addParent(hvTransformer).addParent(plasticProcessing).addRequiredItem(CraftingMaterial.NORMAL_CIRCUIT.getStackNormal(10)).addRequiredItem(TMResource.ELECTRUM.getStackNormal(Type.COIL, 10)).addRequiredItem(TMResource.ENDERIUM.getStackNormal(Type.COIL));
		hvMachines = new Research("hvMachines", new ItemStack(FactoryInit.crusher)).setComplexity(ResearchComplexity.ELECTRICAL).setResearchTime(2500).addParent(advancedCircuit).addRequiredItem(CraftingMaterial.ADVANCED_CIRCUIT.getStackNormal(3)).addRequiredItem(new ItemStack(CoreInit.MachineFrameTitanium)).addRequiredItem(TMResource.ENDERIUM.getStackNormal(Type.COIL)).addRequiredItem(new ItemStack(Items.REDSTONE, 32));
		...
		mvTurbine = new Research("mvTurbine", new ItemStack(EnergyInit.steamTurbineMK2)).setComplexity(ResearchComplexity.ELECTRICAL).setResearchTime(1600).addParent(mvCircuit).addRequiredItem(TMResource.STEEL.getStackNormal(Type.PLATE, 4)).addRequiredItem(CraftingMaterial.NORMAL_CIRCUIT.getStackNormal()).addRequiredItem(new ItemStack(CoreInit.MachineFrameSteel)).addRequiredItem(new ItemStack(Items.REDSTONE, 16));
		charger = new Research("charger", new ItemStack(EnergyInit.charger)).setComplexity(ResearchComplexity.BRONZE).setResearchTime(1500).addParent(basicLvMachines).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal()).addRequiredItem(new ItemStack(EnergyInit.battery, 2)).addRequiredItem(TMResource.COPPER.getStackNormal(Type.CABLE, 5));
		configurator = new Research("configurator", new ItemStack(CoreInit.configurator)).setComplexity(ResearchComplexity.BRONZE).setResearchTime(1600).addParent(charger).addParent(lvAlloySmelter).addParent(eSolderingStation).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal(2)).addRequiredItem(CraftingMaterial.DISPLAY.getStackNormal()).addRequiredItem(TMResource.IRON.getStackNormal(Type.PLATE, 2)).addRequiredItem(new ItemStack(Items.REDSTONE, 6));
		...
		geoThermalGenerator = new Research("geoGenerator", new ItemStack(EnergyInit.geothermalGenerator)).setComplexity(ResearchComplexity.BRONZE).addParent(geoThermalBoiler).setResearchTime(2000).addRequiredItem(new ItemStack(FactoryInit.geothermalBoiler)).addRequiredItem(CraftingMaterial.GENERATOR_COMPONENT.getStackNormal(2)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal()).addRequiredItem(CraftingMaterial.REFINED_BRICK.getStackNormal(4));
		...
		uvLightbox = new Research("uvLightbox", new ItemStack(FactoryInit.uvLightbox)).setResearchTime(1800).addParent(basicLvMachines).setComplexity(ResearchComplexity.ELECTRICAL).addRequiredScan(Blocks.GLOWSTONE, -1, "tile.glowstone.name").addRequiredItem(new ItemStack(Blocks.GLOWSTONE, 2)).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal()).addRequiredItem(new ItemStack(Items.REDSTONE, 6));
		mixer = new Research("mixer", new ItemStack(FactoryInit.mixer)).setResearchTime(1200).addParent(basicLvMachines).setComplexity(ResearchComplexity.ELECTRICAL).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal()).addRequiredItem(new ItemStack(Items.REDSTONE, 6)).addRequiredItem(new ItemStack(FactoryInit.steamMixer));
		laserEngraver = new Research("laserEngraver", new ItemStack(FactoryInit.laserEngraver)).addParent(uvLightbox).setResearchTime(2000).setComplexity(ResearchComplexity.ELECTRICAL).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal(2)).addRequiredItem(new ItemStack(Blocks.REDSTONE_BLOCK, 3)).addRequiredItem(TMResource.RED_DIAMOND.getStackNormal(Type.GEM, 2));
		basicChipset = new Research("basicChipset", CraftingMaterial.BASIC_CHIPSET.getStackNormal()).addParent(laserEngraver).setResearchTime(2200).setComplexity(ResearchComplexity.ELECTRICAL).addRequiredItem(new ItemStack(Blocks.REDSTONE_BLOCK, 3)).addRequiredItem(CraftingMaterial.SILICON_PLATE.getStackNormal(10)).addRequiredItem(new ItemStack(Items.GOLD_NUGGET, 2));
		advChipset = new Research("advChipset", CraftingMaterial.ADVANCED_CHIPSET.getStackNormal()).addParent(basicChipset).addParent(mvCircuit).setComplexity(ResearchComplexity.ELECTRICAL).setResearchTime(3000).addRequiredItem(new ItemStack(Blocks.REDSTONE_BLOCK, 2)).addRequiredItem(TMResource.GOLD.getStackNormal(Type.DUST, 3)).addRequiredItem(CraftingMaterial.SILICON_PLATE.getStackNormal(12)).addRequiredItem(new ItemStack(Items.GOLD_NUGGET, 2));
		advancedExtruder2 = new Research("advExtruder2", new ItemStack(FactoryInit.extruderModule, 1, 2)).setComplexity(ResearchComplexity.ELECTRICAL).setResearchTime(3000).addParent(advancedExtruder).addParent(multiblockComponents).addRequiredItem(TMResource.WOLFRAM.getStackNormal(Type.PLATE, 4)).addRequiredItem(CraftingMaterial.NORMAL_CIRCUIT.getStackNormal(2)).addRequiredItem(new ItemStack(CoreInit.MachineFrameTitanium)).addRequiredItem(new ItemStack(Items.REDSTONE, 16));
		...
		electricalRubberProcessing = new Research("eRubberProcessing", new ItemStack(FactoryInit.electricalRubberProcessor)).addParent(basicLvMachines).setComplexity(ResearchComplexity.ELECTRICAL).setResearchTime(1600).addRequiredItem(CraftingMaterial.RUBBER.getStackNormal(10)).addRequiredItem(CraftingMaterial.BASIC_CIRCUIT.getStackNormal()).addRequiredItem(new ItemStack(CoreInit.MachineFrameBasic));
