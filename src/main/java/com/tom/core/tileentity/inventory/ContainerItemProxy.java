...
public class ContainerItemProxy extends ContainerTomsMod{
	...
	public void detectAndSendChanges(){
		...
		if(sendData)for(IContainerListener crafter : listeners) {
			crafter.sendProgressBarUpdate(this, 0, te.mode ? 1 : 0);
			crafter.sendProgressBarUpdate(this, 1, te.isItemMode ? 1 : 0);
			crafter.sendProgressBarUpdate(this, 2, te.isLocked ? 1 : 0);
			crafter.sendProgressBarUpdate(this, 3, te.useNBT ? 1 : 0);
		}
		lastMode = te.mode;
