...
public class MwGuiLabel {
	...
	private void updateWidthAndHeight() {
		if (this.s1 != null) {
			...
			this.h = this.splitStringWidth(this.str1, this.parentWidth > 0 ? this.parentWidth : 10);
		}
	}

	public int splitStringWidth(String str, int maxLength) {
		return this.fontRenderer.FONT_HEIGHT * this.fontRenderer.listFormattedStringToWidth(str, maxLength).size();
	}
}
