...
public class ScrollableColorSelector extends ScrollableField {
	...
	public Boolean isFocused() {
		if (this.ScrollableNumericTextBoxColourRed.isFocused() || this.ScrollableNumericTextBoxColourGreen.isFocused() || this.ScrollableNumericTextBoxColourBlue.isFocused()) { return true; }
		return false;
	}
	...
	public ScrollableField thisField() {
		if (this.ScrollableNumericTextBoxColourRed.isFocused()) { return this.ScrollableNumericTextBoxColourRed; }
		if (this.ScrollableNumericTextBoxColourGreen.isFocused()) { return this.ScrollableNumericTextBoxColourGreen; }
		if (this.ScrollableNumericTextBoxColourBlue.isFocused()) { return this.ScrollableNumericTextBoxColourBlue; }
		return this.ScrollableNumericTextBoxColourRed;
	}

	public ScrollableField nextField(ScrollableField field) {
		if (this.ScrollableNumericTextBoxColourRed.isFocused()) { return this.ScrollableNumericTextBoxColourGreen; }
		if (this.ScrollableNumericTextBoxColourGreen.isFocused()) { return this.ScrollableNumericTextBoxColourBlue; }
		return field;
	}

	public ScrollableField prevField(ScrollableField field) {
		if (this.ScrollableNumericTextBoxColourGreen.isFocused()) { return this.ScrollableNumericTextBoxColourRed; }
		if (this.ScrollableNumericTextBoxColourBlue.isFocused()) { return this.ScrollableNumericTextBoxColourGreen; }
		return field;
	}
}
