...
public class MwGuiMarkerDialog// extends MwGuiTextDialog
{
	...
	//
	// public MwGuiMarkerDialog(GuiScreen parentScreen, MarkerManager
	// markerManager, String markerName, String markerGroup, int x, int y, int
	// z, int dimension)
	// {
	...
	//
	// public MwGuiMarkerDialog(GuiScreen parentScreen, MarkerManager
	// markerManager, Marker editingMarker)
	// {
